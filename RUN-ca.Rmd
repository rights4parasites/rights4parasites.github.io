...
date: "Expociència - 10 de Maig de 2025"
output: html_document
---

Què passaria si els paràsits triaren els seus hostes a l'atzar? Una sofisticada
simulació duta a terme per Mar i Sandra  demostra que en eixe cas, una terrible possibilitat
seria la següent:
...
dados <- matrix(ncol=6,nrow=6,
                c(0,0,0,0,1,0,          # Collverd
                  0,0,0,0,0,0,          # Tortuga
                  0,0,0,1,0,0,          # Senglar
                  1,0,0,1,0,0,          # Sardina
                  0,0,1,0,0,0,          # Gamba
                  0,0,1,0,0,0), byrow=TRUE)  # Clòtxina
