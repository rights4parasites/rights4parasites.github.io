...
date: "Expociència - 9 de Maig de 2026"
output: html_document
---

Què passaria si els paràsits triaren els seus hostes a l'atzar?
Una sofisticada simulació duta a terme per 
demostra que en eixe cas, una terrible possibilitat seria la
següent:
...
dados <- matrix(ncol=6,nrow=6,
                ...
                c( 0, 0, 0, 0, 0, 0,    # Collverd
                   0, 0, 0, 0, 0, 0,    # Tortuga
                   0, 0, 0, 0, 0, 0,    # Senglar
                   0, 0, 0, 0, 0, 0,    # Sardina
                   0, 0, 0, 0, 0, 0,    # Gamba
                   0, 0, 0, 0, 0, 0),   # Clòtxina
...
```{r, fig.height=6, fig.width=10, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
## Árbol 1
